...
public class BatchBooleanData {
    ...
    public void add(String host, String metric, long primaryTime, long secondaryTime, HostMetric.DateInterval dateInterval, boolean value) {
        String date = TimeUtil.getDate(primaryTime, dateInterval);
        datas.add(new BooleanData(host, metric, date, primaryTime, secondaryTime, value));
    }
}
